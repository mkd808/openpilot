...
def crash_log(candidate):
  ...
  control_keys, vehicle_keys, visual_keys = [
    ...
    "FireTheBabysitter", "NoLogging", "MuteDM", "MuteDoor", "MuteSeatbelt", "MuteOverheated", "OfflineMode", "LateralTune", "AverageCurvature",
    "NNFF", "SteerRatio", "LongitudinalTune", "AccelerationProfile", "AggressiveAcceleration", "StoppingDistance", "SmoothBraking", "Model",
    "MTSCEnabled", "MTSCAggressiveness", "NudgelessLaneChange", "LaneChangeTime", "LaneDetection", "OneLaneChange", "QOLControls",
    "DisableOnroadUploads", "HigherBitrate", "PauseLateralOnSignal", "ReverseCruise", "ReverseCruiseUI", "SetSpeedOffset", "SpeedLimitController",
    "Offset1", "Offset2", "Offset3", "Offset4", "SLCFallback", "SLCPriority", "SLCOverride", "TurnDesires", "VisionTurnControl", "CurveSensitivity",
    "TurnAggressiveness"
  ], [
