...
class LongitudinalMpc:
  ...
  def set_weights(self, custom_personalities=False, aggressive_jerk=0.5, standard_jerk=1.0, relaxed_jerk=1.0, prev_accel_constraint=True, personality=log.LongitudinalPersonality.standard):
