...
void setDefaultParams() {
  ...
  std::map<std::string, std::string> defaultValues {
    ...
    {"AdjacentPathMetrics", FrogsGoMoo ? "1" : "0"},
    {"AdjustablePersonalities", FrogsGoMoo ? "1" : "3"},
    ...
    {"MTSCAggressiveness", FrogsGoMoo ? "100" : "100"},
    {"Model", "0"},
    {"ModelUI", "1"},
    {"MTSCEnabled", "1"},
    ...
    {"RelaxedFollow", FrogsGoMoo ? "30" : "18"},
    {"RelaxedJerk", FrogsGoMoo ? "50" : "10"},
    {"ReverseCruise", "0"},
    {"ReverseCruiseUI", "0"},
    {"RoadEdgesWidth", "2"},
    {"RoadNameUI", "1"},
    ...
    {"StandardFollow", "15"},
    {"StandardJerk", "10"},
    {"StoppingDistance", FrogsGoMoo ? "3" : "0"},
    {"TSS2Tune", "1"},
    {"TurnAggressiveness", FrogsGoMoo ? "150" : "100"},
    {"TurnDesires", FrogsGoMoo ? "1" : "0"},
    {"UnlimitedLength", "1"},
    {"UseSI", FrogsGoMoo ? "1" : "0"},
    {"UseVienna", "0"},
    {"VisionTurnControl", "1"},
    {"WheelIcon", FrogsGoMoo ? "1" : "3"}
  };
